...
def main(sl, ll, pl, model = 'Transformer'):
    ...
    # data loader
    parser.add_argument('--data', type=str, default='test', help='dataset type')
    ...
    parser.add_argument('--dec_in', type=int, default=pl, help='decoder input size')
...
if __name__ == '__main__':
    ...
    for md in ['Transformer', 'Reformer', 'Informer', 'Autoformer']:
        main(sl=sl, ll = 9, pl=pl, model = f'{md}')
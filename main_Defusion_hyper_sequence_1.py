...
def main(num, sl_L, sl_M, sl_S, ll, pl, target, root,model='Transformer', types = 'test'):
    ...
    # data loader
    parser.add_argument('--data', type=str, default=f'{types}', help='dataset type')
...
if __name__ == '__main__':
    ...
    data= pd.read_csv(r'/home/oem/PycharmProjects/DefusionFormer_V2/Data/test_1.csv')
    # sl_L = 336
    sl_M = 72
    sl_S = 9
    pl = 24
    ...
    for sl_M in tqdm(M):
        for sl_S in S:
            main(num = i,sl_L = sl_M, sl_M = sl_M, sl_S = sl_S, ll = 24, pl=pl, target = f'{a.columns[2]}', model = f'{MODEL}', root = root, types = 'Multi_Input')
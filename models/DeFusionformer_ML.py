...
class DeFusionformer_ML(nn.Module):
    """
    Vanilla Transformer with O(L^2) complexity
    """
    def __init__(self, configs):
        super(DeFusionformer_ML, self).__init__()
    ...
    def forward(self, x_L_enc, x_L_mark_enc, x_M_enc, x_M_mark_enc, x_S_enc, x_S_mark_enc, x_dec, x_mark_dec,
        ...
        enc_L_out, _ = self.encoder(enc_L_out, attn_mask=enc_self_mask)
        ...
        enc = torch.concat([enc_long, enc_mid], dim=1)
